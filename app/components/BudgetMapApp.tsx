                ...
                <div className="mt-5">
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-2xl border-2 border-budget-surface bg-budget-white py-2.5 text-[12px] font-extrabold text-budget-text transition disabled:cursor-wait disabled:opacity-60"
                    >
                    ...
                    <button
                      ...
                      className="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-2xl border-0 bg-budget-primary py-2.5 text-[12px] font-extrabold text-white shadow-[0_6px_16px_rgb(0_168_120_/0.35)]"
                    >
