...
export default function BudgetMapApp() {
  ...
  const panelHero = (
    ...
    <section
      className="absolute left-3 right-3 z-30 rounded-[24px] border border-budget-surface/80 bg-budget-white px-4 pb-2 pt-2.5 shadow-budget-header"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span
                  className="shrink-0 text-[13px] font-semibold tracking-tight"
                  style={{ color: "#0D1F1A" }}
                >
                  Max budget :
                </span>
                <span
                  className="min-w-0 font-extrabold tabular-nums tracking-tight text-budget-primary"
                  style={{ fontSize: "14px" }}
                  aria-live="polite"
                >
              ...
              <input
                ...
                style={{
                  ["--range-progress" as string]: `${mapBudgetPercent}%`,
                  display: "block",
                  padding: 0,
                  margin: 0,
                }}
                aria-valuetext={formatBudgetCap(mapBudget)}
