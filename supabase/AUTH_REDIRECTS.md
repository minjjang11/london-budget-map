...
- `maimomap://auth/callback` (Capacitor — `redirectTo` for native Google sign-in)
- `https://london-budget-map.vercel.app/auth/oauth-handoff.html` (optional legacy bridge if an old build lands on HTTPS first)
